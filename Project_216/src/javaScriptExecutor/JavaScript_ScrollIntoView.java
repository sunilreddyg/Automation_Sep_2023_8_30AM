...
public class JavaScript_ScrollIntoView {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//Now Selenium 4 had direct method for scrolltoview
		Thread.sleep(5000);
		WebElement Homescreen=driver.findElement(By.xpath("//a[@data-csa-c-slot-id='nav_cs_3']"));
		new Actions(driver).scrollToElement(Homescreen).perform();
