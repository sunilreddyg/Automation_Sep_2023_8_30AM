...
public class BackGroundCheck 
{
	...
	public void book4_is_selected() 
	{
	   System.out.println("Book 4 is Selected");
	}
	@Then("Check Author of book4 is {string}")
	public void check_author_of_book4_is(String string) {
	   System.out.println("Book 4 author name is :--> "+string);
	}
